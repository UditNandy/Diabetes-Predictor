...
# Conclusion:So we can clearly see that we are getting more accuracy in Logistic Regression and KNN but recall value in Logistic Regression is
# high then KNN and as this is a disease predictor so here recal can be given a priority so we will choose Logistic as our final model
